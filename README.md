...
**2026-09-05 임피던스·주문 갱신:** [실제 화면과 옵션별 이유](docs/jlcpcb/README.md) · [계산기 결과 및 CAD 변경/검증](docs/jlcpcb/IMPEDANCE.md). 현재 W/G=0.234/0.216 mm, RF W=0.357 mm를 적용했다.

**Molex 배선 후속 개선:** [전후 그림·수치·설계 판단](docs/molex-routing/README.md). 신호 비아 0개를 유지하며 폭 0.234 mm 통일, A/B 길이 차이 0.79/0.99 mm를 적용했다.
